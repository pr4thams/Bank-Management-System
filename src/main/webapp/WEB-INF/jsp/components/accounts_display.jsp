                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingOne">
                        <button
                                ...
                                data-bs-target="#flush-${account.account_id}"
                                aria-expanded="false"
                    ...
                    >
                        <div class="accordion-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex">Created at<span class="ms-auto"><b>${account.updated_at}</b></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<!-- End of Container: Accordion Menu -->